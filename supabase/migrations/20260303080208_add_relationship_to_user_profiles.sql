...
DROP FUNCTION IF EXISTS public.update_own_profile(p_full_name text, p_age integer, p_city text, p_education text, p_zip_code text, p_state text, p_street text, p_street_number text, p_complement text, p_passport_phase text);

-- 2. Create the new function signature with dependent fields
