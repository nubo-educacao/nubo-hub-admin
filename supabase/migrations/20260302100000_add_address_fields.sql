-- ============================================================
-- 20260302100000_add_address_fields.sql
-- Adds address fields to user_profiles and updates RPCs
-- ============================================================

-- 1. New address columns
...
ALTER TABLE public.user_profiles ADD COLUMN IF NOT EXISTS street_number TEXT;
ALTER TABLE public.user_profiles ADD COLUMN IF NOT EXISTS complement TEXT;

-- 2. Recreate get_own_profile to recompile and see new columns
...
-- 3. Replace update_own_profile to accept new address params
